...
The modules and surrogate functions will depend mainly on the following packages:   
  ...
  [{potools}](https://CRAN.R-project.org/package=cli) specifically used to translate all the messages in the package into other languages such as French, Spanish, etc,
  [{rlang}](https://CRAN.R-project.org/package=cli) mainly used here for its `.data` functionality to retrieves data-variables from the data frame,
