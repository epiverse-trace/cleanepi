...
6. **age_remainder_unit**: A parameter used to determine the number of the remaining days (remainder_days) or weeks (remainder_weeks) or months (remainder_months), depending on the value of the 'age_in' parameter, after calculating the age. By default, the function returns decimal age i.e. `age_remainder_unit = "digits"`.
