...
vignette: >
  ...
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
>>>>>>> 6163c8836a2865fcddd8811f4ed17a0ce56eb2ad
---
...
**cleanepi** is an R package to clean, curate, and standardize epidemiological data. It performs several data cleaning tasks that an end-user would anticipate to be performed on a cluttered dataset. 
...
6. converting character columns into date if the column actually contains date values at a specific extent (default is 50% of the values are date)
