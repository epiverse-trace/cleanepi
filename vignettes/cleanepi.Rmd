...
Note that when the first iteration of constant data removal results in a dataset with empty rows and/or columns and constant columns, this process will be carried on several times until there is no more constant data. Rows and columns that were deleted at any iterations will be reported in the report object.
