...
Each module has specific parameters. The parameters needed for the main function
of each module are described the sections below.
In the following chunk, we will define the list of the cleaning operations that
we want to perform on the input data.

```{r eval=TRUE, comment="define_cleanining_params"}
