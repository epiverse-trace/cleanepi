...
**cleanepi** is developed by  the [Epiverse-TRACE](https://data.org/initiatives/epiverse/) team at  the London School of Hygiene and Tropical Medicine.
...
=======
`clean_data()` returns a list containing dataframe for the  processed input data and a list of reports for each operation. Below is typical example of how to use `clean_data()` function. 
>>>>>>> origin/develop
