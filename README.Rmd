...
**cleanepi**  performs several data cleansing tasks that an end-user would anticipate to be performed on a cluttered dataset. These include standard tasks such as removing duplicated and empty rows and columns, detecting columns of constant value, replacing missing values, ensuring uniqueness of uniquely identified columns, and converting dates in a string to date-format. **cleanepi** can also standardize column entries into specified formats, calculate age (in years, months, weeks, or days) for a given column and reference data, and perform further dictionary-based cleaning operations.
**cleanepi** expects input data  in  a form of  dataframe-like structure (`data.frame`, `tibble`, etc) or `linelist` object and returns dataframe of processed data and list of reports for each task.  
