...
The current development version of **cleanepi** can be installed from  [GitHub](https://github.com/epiverse-trace/cleanepi).
...
lifecycle](https://www.reconverse.org/lifecycle.html). This means that it is functional, but interfaces and functionalities may change over time.
