...
**cleanepi** expects input data  in  form of  dataframe-like structure (`data.frame`, `tibble`, etc) or `linelist` object. 
...
<input type="checkbox" unchecked> build function to display the cleaning report </input>
